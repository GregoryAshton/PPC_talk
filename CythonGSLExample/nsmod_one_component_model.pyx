...
The solver uses GSL odeint to solve the odes and Cython_GSL as a python
interface documentation can be found at
...
def main (epsI1=0.0, epsI3=1.0e-9, epsA=5.0e-11 , omega0=1.0e4,
    error=1e-14, t1=1.0e9 , eta=1e-4, chi = 30.0, anom_torque=True ,
    a_int=0.5, file_name="results_CythonGSL.txt", n=None, phi0=0.0):
